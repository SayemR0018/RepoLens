...
function smallResult(ref: RepoRef): AnalyzeResult {
  ...
  return {
    ...
    repo: ref.repo,
    defaultBranch: "main",
    description: "Deterministic small sample. GitHub and OpenAI were not called.",
    source: "mock",
...
function mediumResult(ref: RepoRef): AnalyzeResult {
  ...
  return {
    ...
    repo: ref.repo,
    defaultBranch: "main",
    description: "Deterministic medium sample. GitHub and OpenAI were not called.",
    source: "mock",
    masterPrompt: assembleMasterPrompt(ref.owner, ref.repo, sections),
    omissions,
    explain: {
      ...
      highlights: [
        ...
        "The master prompt tells ChatGPT-astra the rebuild order and what was not read.",
...
function monoResult(ref: RepoRef): AnalyzeResult {
  ...
  return {
    ...
    repo: ref.repo,
    defaultBranch: "main",
    description: "Deterministic monorepo sample. GitHub and OpenAI were not called.",
    source: "mock",
    masterPrompt: assembleMasterPrompt(ref.owner, ref.repo, sections),
    omissions,
    explain: {
